...
// Okay, the single-pass solution is indeed an order of magnitude faster. That makes sense.
func BenchmarkMinMaxSum2(b *testing.B) {
	for i := 0; i < b.N; i++ {
		MinMaxSum2([]int32{4, 3, 1, 2, 5})
	}
}
